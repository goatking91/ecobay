...
/*	private String pnum, returnpage;*/
	...
	public String toString() {
		return "MemberProductVO [product_cd=" + product_cd + ", product_nm=" + product_nm + ", member_id=" + member_id
				...
				+ use_yn + ", viewcnt=" + viewcnt + ", payment_proc_cd=" + payment_proc_cd + ", rn=" + rn
				+ ", searchVal=" + searchVal + ", filename_thumb=" + filename_thumb + ", acutdate_start_str="
				+ acutdate_start_str + ", acutdate_end_str=" + acutdate_end_str + ", start=" + start + ", end=" + end
				+ ", page=" + page + ", startpage=" + startpage + ", endpage=" + endpage + ", pagecount=" + pagecount
				+ ", temp=" + temp + "]";
	}
