		...
		<div class="col-md-12">
	        ...
	        <security:csrfInput/><!-- 폼태그 처리시 시큐리티 태그라이브러리 -->
				...
				<div class="form-group row row">
					...
					<div class="col-sm-4">
						<input class="form-control" id="member_pwd" name="pwd" type="password" placeholder="영문,숫자,특수문자를 포함한  8~16자리 입력">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-3 col-form-label text-right" for="pwdck">비밀번호 확인</label>
					<div class="col-sm-4">
						<input class="form-control" id="pwdck" name="pwdck" type="password" placeholder="비밀번호를 다시 한 번 입력해주세요">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-3 col-form-label text-right" for="birth">생년월일</label><!-- datepicker6자리로 바꾸기 930811-->
					<div class="col-sm-3">
						<input class="form-control" id="birth" name="birth" type="text" placeholder="올바른 생년월일을 선택해주세요">
					</div>
				</div>
				...
				<div class="form-group row">
					<div class="col-sm text-center">
						<input type="submit" id="regbutton" class="btn btn-lg btn-primary" value="등록">&nbsp;
