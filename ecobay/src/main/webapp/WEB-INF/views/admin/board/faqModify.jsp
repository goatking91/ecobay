...
<div class="content-wrapper">
	...
	<div class="container" style="margin-top: 50px;">
		<form name="faqRegForm" action="/admin/board/faqmod.do" class="form-horizontal" method="post">
			...
			<div class="table-responsive">
				<table class="table">
					...
					<tr>
						...
						<td><input class="form-control" type="text" id="title" name="title" value="${faq.title }"></td>
					</tr>
					
					<tr>
						<th class="colTitle">내용</th>
						<td>
							<textarea rows="15" class="form-control" id="content" name="content">${faq.content }</textarea>
						</td>
					</tr>
