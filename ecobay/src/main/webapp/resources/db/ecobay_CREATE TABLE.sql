...
, MEMBER_ID VARCHAR(100) NOT NULL
, REGDATE DATETIME NOT NULL default now()
, PRIMARY KEY(PRODUCT_CD, MEMBER_ID)
);

ALTER TABLE PRODUCTWISH 
	ADD CONSTRAINT fk_productwish_productcd
	Foreign KEY ( PRODUCT_CD ) 
	REFERENCES PRODUCT ( PRODUCT_CD )
	ON DELETE CASCADE;
...
, PAYMENT_PROC_CD VARCHAR(5) NOT NULL default '0'
);
...
, REGDATE DATETIME NOT NULL default now()
, PRIMARY KEY(PRODUCT_CD, MEMBER_ID, MONEY_BID)
);
...
( 
  CATEGORY_CD VARCHAR(5) NOT NULL default '' PRIMARY KEY
, CATEGORY_NM VARCHAR(100) NOT NULL  default ''
, REGDATE DATETIME NOT NULL default now()
);
...
, TITLE VARCHAR(500) NOT NULL 
, CONTENT TEXT NULL 
, CATEGORY_CD VARCHAR(5) NOT NULL default ''
, VIEWCNT INT(6) NOT NULL default 0
, REGDATE DATETIME NOT NULL default now()
, MODDATE DATETIME NOT NULL default now()
);
...
( 
  QNARP_IDX INT(6) NOT NULL AUTO_INCREMENT
, QNA_IDX INT(6) NOT NULL
, CONTENT TEXT NULL 
...
( 
  IDX_CD INT(6) NOT NULL AUTO_INCREMENT PRIMARY KEY
, MEMBER_ID VARCHAR(100) NOT NULL 
, REGCONTENT TEXT NULL
, CANCONTENT TEXT NULL
, BLACK_YN BOOLEAN NOT NULL default TRUE
, REGDATE DATETIME NOT NULL default now()
